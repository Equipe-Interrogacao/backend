"""
Schemas Pydantic para áreas protegidas (UC, TI, Assentamento, Quilombola).
"""
...
class AreasProtegidasIngestaoStatusResponse(BaseModel):
    rodando: bool
